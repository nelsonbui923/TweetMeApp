...
class TweetTestCase(TestCase):
    def setUp(self):
        ...
        self.user2 = User.objects.create_user(username='abcd', password='password1')
        Tweet.objects.create(content="my 1st tweet", user=self.user)
        Tweet.objects.create(content="my 1st tweet", user=self.user)
        Tweet.objects.create(content="my 1st tweet", user=self.user2)
        self.currentCount = Tweet.objects.all().count()

    def test_tweet_created(self):
        tweet_obj = Tweet.objects.create(content="my 4th tweet", user=self.user)
